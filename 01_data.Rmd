...
structure. That could be the previously mentioned rows and columns, or something
...
least a good way, to store it. Thankfully, we have mostly left behind the 20th
century's favorite way of storing data: paper in filing cabinets. Our new
methods are definitely less flammable but also have a higher barrier to entry.
There are many more types of data stores available now as well. This means you
will need to make a decision on which one to use. Ultimately, the best way to
store your data will depend on the data you want to store and the questions you 
want to ask with it.
...
Data type also influences how data is stored. Unlike other characteristics we
will discuss later, an individual data point can have a type.
...
1900-01-02. The underlying information is the same (1), but the
...
lend themselves to particular data structures over others.
...
ask. Each data structure will make some types of questions easier to ask and
others harder. If you want to ask disparate types of questions, you may need to
...
spread of a particular measurement over the entire dataset. It can also help
...
England). Questions like the what was the average age at death for the Tudors
