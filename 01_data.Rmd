...
mpg_all[, horsepower:=as.numeric(horsepower)]
...
(or vertices)
which represent entities in the data, and edges which represent relationships
between those entities. The number of edges separating an entity from a common
root node defines that entity's place in the hierarchy. When viewing tree 
structured data on a computer, it often looks very "nested", like files in a
file directory on your computer. In fact, tree data is sometimes referred to as 
document structured data because of this. 
