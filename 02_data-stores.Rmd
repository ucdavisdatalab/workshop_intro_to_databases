...
store your data digitally: in flat files with a GUI or in a database.


*Figure 3.1: A tree diagram enumerating different ways of managing your data,* 
...
stored in flat files via a **graphical user interface** (GUI). Most GUIs are
specific to file type or data structure. For example, spreadsheet applications
like Microsoft Excel or Google Sheets can edit xlsx and csv files, and
applications like Graphviz can visualize and modify DOT files.
...
Database management systems have several advantages over GUIs with flat files.
...
*Figure 3.2. A partial Entity Relationship Diagram for the IMDB non-commercial
