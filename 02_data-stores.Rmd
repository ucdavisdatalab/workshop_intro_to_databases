...
> A repository for persistently storing and managing collections of data which 
> include not just repositories like databases, but also simpler store types 
> such as simple files, emails etc.
>
> Wikipedia
...
library qualify as analog data stores.
