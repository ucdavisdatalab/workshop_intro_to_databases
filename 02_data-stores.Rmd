...
are not generally human readable. Databases have several key characteristics
that differentiate them from other data stores like flat files.
...
Most databases do not have a Graphical User Interface (GUI) like Microsoft Excel
or Google Sheets. This means you will be interacting with the database through
a query language. If you already use a programming language like R or
python, this will be very familiar to you. If not, don't worry. Query languages,
like SQL, are designed to be simpler and easier to use than most programming
languages, but also incredibly powerful.
