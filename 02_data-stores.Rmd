...
database and my SQL query. If I find problems in the data at a later time, I
don't need to send a whole new data set, and potentially introduce confusion
over what data people should be using. All I need to do is update the database,
and tell my colleague to rerun their SQL query. No additional computer storage
necessary.
...
extract data from the people table, that change will be automatically
propagated to our new data. While it may be easy to successfully fix 5 errors,
it will be much harder to fix 50, or 5,000. This is especially true if they are
scattered throughout your data set and not just in a single column.
