...
Users interact with an RDBMS through SQL[^1] instead of a graphical user interface. SQL 
allows you to standardize your interactions with a database. It
...
to entry than a graphical user interface like Excel.To learn more about using SQL in
...
extracting the Die Hard movie franchise information took about half a second.
...
<!--
In the imdb database the titles table alone had 10 million rows and querying it
took 0.026 seconds

die hard sheet = 260
die hard rdb = 5 + 80 + 56 + 15 = 156
 0.5 seconds
