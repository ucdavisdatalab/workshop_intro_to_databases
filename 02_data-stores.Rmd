...
could be considered a data store, albeit a bad one.
...
mistake. If we accidentally got Bruce Willis's birth date wrong, we would have
...
| Pros                                 | Cons                                 |
+======================================+======================================+
| Works with semi- and unstructured    | BASE (not ACID)                      |
| data                                 |                                      |
+--------------------------------------+--------------------------------------+
| Horizontal scaling                   | Data is not normalized               |
+--------------------------------------+--------------------------------------+
| Data structure is not predetermined  | Limited support for joins and        |
|                                      | indexing                             |
+--------------------------------------+--------------------------------------+
