...
Research Question → Data Structure
...
XX → Computing Resources
:::


<!-- ## Topics Covered {background-image="img/slides/trail.png"
                  background-size="10%" background-opacity="0.9"
                  background-position="92% 7%"}
...
-   How to pick a data store based on your research question?
-->

## Questions to Consider {background-image="img/slides/trail.png"
                                background-size="10%"
...
<center> **Multiple questions may mean multiple data stores**<center>
