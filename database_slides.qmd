...
-   Welcome
-   Introduce self
-   Overview = no coding, not no thinking
-   Point is to ask questions about how your research fits
-   Think about current or future data problems
:::
...
GGE graduate once tweeted "working on a phd is like working on a group 
    project with someone who made a whole bunch of mistakes at the beginning,
    but that person is yourself from four years ago."
...
-   Query - database command: create read update delete
...
:::{.notes}
1.  data structure can be more complex
2.  queries make interaction reproducible
3.  multiple people can access and edit without conflicts
4.  higher data size limits
...
-   Supports relatively low complexity in dat
...
-   SQL makes everything standarized and reproducible
-   update database once and everyoen runs new query and gets new data
...
-   If you like the features of a relational database but you don't have 
    tabular data
-   sometimes data is contained within database, sometimes database sits on top
    of flat files
:::
