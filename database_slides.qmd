...
Want to take your research computing to the next level?

The UC Davis Datalab offers two workshops during spring quarter to do just that.
The Introduction to SQL Workshop (event, [[reader]{.underline}][dl_sql]), offered 
on 4/18, gives you hands on experience interacting with relational databases 
using SQL. The Spatial SQL (event, [[reader]{.underline}][dl_ssql]) 
offered on 5/3, gives you the tools to add spatial data to your relational
database toolkit. 

<br>

![](img/slides/datalab-logo-full-color-rgb.png)
